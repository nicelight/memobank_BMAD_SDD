...
- `.memory-bank/packets/` stores optional derivative Execution Packets for task runtime context;
...
Both respect `runtime_context.packet_required`; they do not require packets from
tier alone.
