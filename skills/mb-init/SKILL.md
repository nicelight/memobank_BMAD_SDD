...
- Skeleton bootstrap creates no fake feature docs; task planning starts later with `/write-prd`, `/spec-init`, `/prd`, mandatory `/spec-design`, then `/prd-to-tasks FT-<NNN>`.
