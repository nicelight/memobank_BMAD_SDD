...
- Skeleton bootstrap creates no fake feature docs; task planning starts later with `/write-prd`, `/spec-init`, `/prd`, `/spec-design FT-<NNN>`, then `/prd-to-tasks FT-<NNN>`.
